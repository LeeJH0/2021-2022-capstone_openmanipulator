...
class OpenManipulatorMaster : public RobotisManipulator
{
 private:
  ...
  // Service master_cleint
  ros::ServiceClient master_client ;
  
  // ++
  ros::Subscriber ros_tutorial_sub ;
  // void msgCallback(const ros_tutorials_topic::MsgTutorial::ConstPtr  &msg_master) ;
 ...
 public:
  ...
  void msgCallback(const ros_tutorials_topic::MsgTutorialConstPtr& msg_master);
